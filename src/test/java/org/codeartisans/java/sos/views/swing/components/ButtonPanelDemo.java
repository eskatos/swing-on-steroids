...
import org.codeartisans.java.sos.views.swing.components.ButtonPanel;
        ...
        extends JFrame
{
    ...
    public ButtonPanelDemo()
    {
        ...
        final ButtonPanel radioGroupPanel = createRadioJXButtonPanel();
        topPanel.add(radioGroupPanel);

        final ButtonPanel checkBoxPanel = createCheckBoxJXButtonPanel();
    ...
    private ButtonPanel createRadioJXButtonPanel()
    {
    ...
    private ButtonPanel createCheckBoxJXButtonPanel()
    {
        ButtonPanel panel = new ButtonPanel();
        panel.setLayout(new GridLayout(0, 1));
